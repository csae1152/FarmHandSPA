<template>
  <div class="flex justify-center full-height" :class="heightSize">
    <div class="row gt-sm">
      <div class="row">
        <div class="list">
          <label class="item" v-for="color in colors" :key="color">
      ...
      <div class="row">
        <div class="list fit">
          <label class="item" v-for="tone in colorTones" :key="tone">
            <div class="item-primary">
    ...
    <div class="row gt-sm">
      <div class="row ">
        <div class="list fit">
          <label class="item" v-for="bClass in buttonClasses" :key="bClass">
            <div class="item-primary">
      ...
      <div class="row">
        <div class="list">
          <label class="item" v-for="logoName in logos" :key="logoName">
            <div class="item-primary">
